"""
Problem Statement: "Employee Attrition": The task is to find through predictive modelling,
why employees leave the company prematurely and the redundant factors that cause this Attrition.
 
Project by: Ajay Sethuraman
Under the guidance of: Mr. Muthuraja Sivanantham
...
# Here we are doing some basic exploratory analysis on the data, bringing up information on the data and
# taking a look at the data in a visual manner. We are also looking at the missing values and fixing them.
...
# As seen above the data contains some missing values, so we will fill them by mean for the numerical values and use ffill for the non-numerical value.
...
# Running VIF to check highly correlated values, since they may be redundant.
...
# When we compare the values between the hired and those who leave, we can see that, for the hired the satisfaction ranges that prevail are those of satisfaction and regular satisfaction,
# the two corresponding to 87% of the hired. For those who leave the dissatisfied range alone corresponds to 49% of this set. 

# Hence, almost half of the employees who leave the company are dissatisfied.
...
# The Sales department is the one with the largest number of employees, followed by the Technical and Support department,
# totaling 9,089 employees. Management is the smallest of them with 630 employees.
...
# Here we can see the people who have worked in the company between 2 and 10 years. For those who worked for a total of 2 years,
# the difference is small between the hired and who leaves. The employee who leaves worked for more hours.
# The data for those who worked for 3 years is quite different from the others, they exhibit a new grouping of people who leaves and worked
# less hours than the average monthly. During the univariate graphs section, seeing the distribution of the total number of people per years worked,
# observe a peak in the 3rd year and from there a fall in the total of people per year after the 4th year. look at outliers
...
# We see dissatisfaction with employees who leave the company in the 3rd or 4th year. People who left the company in the 5th grade,
# mostly showed low or high satisfaction. Most of then who worked at the company for 6 years demonstrated a high satisfaction level of over 0.75.
# Again the 3rd year is a major factor. The people who left the company in the 3rd year received a low score in the last evaluation, a fact that
# does not repeat from the 4th to the 6th year, where the majority of those employees received grades higher than 0.8.
...
# Both people with high, medium or low salary worked on 2 projects or more. Around 140 people worked on 7 projects and received a low salary.
# So answering the question, there is no evidence of connection between number of projects and salary range.
...
# People who left and also worked on 7 projects, and received low scores would have been dissatisfied. Those who left the company involved in2 projects,
# regardless of the salary range, predominantly received low scores in their evaluations. People with more than 4 projects tended to receive better grades in their assessments.
...
# In this plot we have the proportion of the satisfaction of who left by numbers of projects. <br><br>People with 2 projects showed a low to regular satisfaction.
# The group with 6 or 7 projects also showed a low to regular satisfaction level. <br><br> Employees who worked on 4 or 5 projects had a predominantly high satisfaction.
...
# Both people with high, medium or low salary worked on 2 projects or more. 144 people worked on 7 projects and received a low salary.
# So there is no proof that the larger the number of projects, the better the salary range.

# Even though they have suffered an accident at work, the employees remain in the company. <b> This variable does not seem to be related to the employee's exit.
...
# The people who left the company were <b>overburdened and unsatisfied.
...
# As the values in the column satisfaction_level and last_evaluation are not in the order of the other entries we can multiply the values in
# the column by a constant to make it in the order of the column values.
...
# AUC Score for Logistic Regression: 0.8248766698280362
# AUC Score for Random Forests: 0.9743138725306396
# AUC Score for Decision Trees: 0.9919011349071563
# AUC Score for KNN: 0.9769688715381165
